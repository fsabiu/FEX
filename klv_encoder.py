...
class MISB0601Encoder:
    ...
    TAG_GIMBAL_ABS_YAW = 105    # Gimbal absolute yaw angle (degrees)
    TAG_GIMBAL_ABS_PITCH = 106  # Gimbal absolute pitch angle (degrees)
    TAG_GIMBAL_ABS_ROLL = 107   # Gimbal absolute roll angle (degrees)
