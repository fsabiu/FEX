...
def detect_yolo():
    ...
    global yolo_model
    result = utils_yolo_multigpu.detect_yolo(yolo_model, b64_image, confidence)
...
def app_init():
    global yolo_model
    yolo_model = utils_yolo_multigpu.load_yolo("best_tanks_militaryTrucks.pt")
